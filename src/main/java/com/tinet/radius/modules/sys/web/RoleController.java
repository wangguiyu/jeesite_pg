...
import com.tinet.radius.common.utils.Collections3;
...
//		}
	...
	public String selectUserToRole(Role role, Model model) {
		...
		model.addAttribute("role", role);
		model.addAttribute("userList", userList);
		model.addAttribute("allUserList", systemService.findUser(new User()));
	...
	public List<Map<String, Object>> users(HttpServletResponse response) {
