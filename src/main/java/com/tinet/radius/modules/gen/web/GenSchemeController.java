 ...
 */
package com.tinet.radius.modules.gen.web;
...
import com.tinet.radius.modules.gen.service.GenSchemeService;
import com.tinet.radius.modules.gen.service.GenTableService;
...
public class GenSchemeController extends BaseController {
	...
	public String form(GenScheme genScheme, Model model) {
		if (StringUtils.isBlank(genScheme.getPackageName())){
			genScheme.setPackageName("com.tinet.radius.modules");
		}
